...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        {!! Form::open(['route' => ['employee.update',$empdata->id]]) !!}

        {{ Form::label('Name :') }}
        {{Form::text('name',$empdata->name,array('class'=>"form-control"))}}
        <br>

        {{ Form::label('Address :') }}
        {{Form::text('address',$empdata->address,array('class'=>"form-control"))}}
        <br>
        ...
        <br>
        {{ Form::label('NIC :') }}
        {{Form::text('nic',$empdata->nic,array('class'=>"form-control"))}}
        ...
        {{Form::text('contactno',$empdata->contactno,array('class'=>"form-control"))}}
        <br>
