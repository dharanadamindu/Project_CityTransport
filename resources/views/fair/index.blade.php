    ...
    <table class="table table table-hover table-dark">
     <thead>
      <tr>
        ...
        <th width="" class="sorting" data-sorting_type="asc" style="cursor: pointer">Fair </th>
        <th width="" class="sorting" data-sorting_type="asc" style="cursor: pointer">Duration </th>
        <th colspan="2">
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"/fair/fair/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,
