...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <br>
        Fair :- <input type="text" class="form-control" value="{{$fairData->bfair}}" name="bfair" required data-parsley-type="number" data-parsley-type-message="please enter valid fair" data-parsley-trigger="keyup">
        <br>
        Duration :- <input type="text" class="form-control" value="{{$fairData->duration}}" name="duration" required data-parsley-type="number" data-parsley-type-message="please enter valid duration" data-parsley-trigger="keyup">
