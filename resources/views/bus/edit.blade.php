...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        {!! Form::open(['route' => ['bus.update',$busData->id],'data-parsley-validate'=>'']) !!}

        {{ Form::label('Bus Registration number :') }}
        {{Form::text('b_regno',$busData->b_regno,array('class'=>"form-control", 'required', 'data-parsley-maxlength'=>"8", 'data-parsley-maxlength-message'=>"Registration is wrong.", 'data-parsley-trigger'=>"keyup"))}}
        <br>

        {{ Form::label('Type :') }}
        {{Form::text('v_type',$busData->v_type,array('class'=>"form-control", 'required', 'data-parsley-maxlength'=>"30", 'data-parsley-maxlength-message'=>"Wrong vehicle type", 'data-parsley-trigger'=>"keyup"))}}
        <br>

        {{ Form::label('Model :') }}
        {{Form::text('m_type',$busData->m_type,array('class'=>"form-control", 'required', 'data-parsley-maxlength'=>"30", 'data-parsley-maxlength-message'=>"Wrong vehicle Model", 'data-parsley-trigger'=>"keyup"))}}
        <br>

    
        {{Form::hidden('_method','PUT')}}
        {{Form::submit('Edit Employee',array('class'=>"btn btn-success waves-effect waves-light"))}}
        {!! Form::close() !!}
