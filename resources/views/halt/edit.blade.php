...
<div class="container-fluid">
        {!! Form::open(['route' => ['halt.update',$hltdata->id],'data-parsley-validate'=>'']) !!}
        ...
        <div class="row">
            <div class="col-sm-6">
                    ...
                    {{Form::text('name',$hltdata->name,array('class'=>"form-control", 'maxlength'=>'50' , 'placeholder'=>'Halt Name'))}}
            ...
            <div class="col-sm-6">
                    ...
                    {{Form::textarea('description',$hltdata->description,array('class'=>"form-control", 'rows'=>'5', 'placeholder'=>'Type description'))}}
                    ...
                    {{Form::textarea('timetable',$hltdata->timetable,array('class'=>"form-control", 'rows'=>'10', 'placeholder'=>'Enter time table here'))}}
                    <br><br>


                    {{Form::hidden('_method','PUT')}}
                    {{Form::submit('Edit Halt',array('class'=>"btn form-control btn-success shadow"))}}
            </div>
        </div>
