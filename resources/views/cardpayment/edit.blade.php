...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        {{Form::text('b_regno',$empData->b_regno,array('class'=>"form-control", 'required', 'data-parsley-maxlength'=>"8", 'data-parsley-maxlength-message'=>"Registration number is too long .", 'data-parsley-trigger'=>"keyup"))}}
